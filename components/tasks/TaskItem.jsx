    ...
    return (
        <>
            <div className="flex flex-row items-center">
                <span className="text-center bg-zinc-800 outline outline-gray-500 w-xs min-w-xs">
                    <div className={`${edit ? "hidden" : "flex"}`}>
                        <button className="w-12">{count}</button>
                        <button className={`grow text-left ml-2`}>{text}</button>
                        <button className="flex items-center justify-center size-14 border-gray-500 bg-zinc-500" onClick={handleOpenEdit}>
                    ...
                    <div className={`edit-panel ${edit ? "flex" : "hidden"}`}>
                        ...
                        <button className="size-14 border-gray-500 flex items-center justify-center bg-teal-600" onClick={handleConfirmTask}>
