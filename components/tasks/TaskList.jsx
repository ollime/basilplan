...
function TaskList() {
    ...
    return (
        <>
            <div>
                <div id="task" className="flex flex-col w-md mt-5">
                    ...
                    {taskList}
                    <button className="size-10 bg-teal-700 w-xs outline outline-gray-400 rounded-b-lg" onClick={handleAddTask}>Add Task +</button>
                </div>
            </div>
        </>
    )
